...
function getPercentile(wpm: number): number {
  // EN: Approximate percentile reference | HI: Ye sirf andaza hai, actual data alag ho sakta hai
...
export default function TestPage() {
  // EN: Test flow state + timers | HI: Yahan hum poore test ka state manage kar rahe hain
  ...
  // EN: Countdown + live WPM | HI: Timer aur live speed dono yahin update hote hain
  useEffect(() => {
  ...
  // EN: Scroll based estimated progress | HI: Scroll jitna hua utne shabd ginte hain
  useEffect(() => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#fff1f0] via-[#ffe9e4] to-[#ffe4e1] px-4 py-10 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-4xl">
        {/* EN: Glass card for premium feel | HI: Soft peach card se luxury look aata hai */}
